...
The Monte Carlo cosmic-ray reconstruction efficiency, obtained with a general Monte Carlo distribution as defined in section \ref{sec:merging}, can be directly defined as:
\begin{equation}
