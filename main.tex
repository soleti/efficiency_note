...
\begin{figure}[htbp]
\includegraphics[width=\linewidth]{mucs.png}
...
\begin{figure}[htbp]
\includegraphics[width=0.36\linewidth]{3devd.png}\includegraphics[width=0.6\linewidth]{mipcut.pdf}
...
%\begin{figure}[htbp]
%\begin{subfigure}{0.52\textwidth}
%\includegraphics[width=\linewidth]{xy_before.pdf}
%\caption{Efficiency as a function of $\theta_{xy}$.} \label{ref:xy_before}
%\end{subfigure}
%\hspace*{\fill}
%\begin{subfigure}{0.52\textwidth}
%\includegraphics[width=\linewidth]{yz_before.pdf}
...
\begin{center}
\includegraphics[width=0.3\linewidth]{evd_short.png}\hspace*{1em}\includegraphics[width=0.3\linewidth]{short.png}
\end{center}
...
\begin{subfigure}{1\textwidth}
\begin{center}
\includegraphics[width=0.3\linewidth]{evd_wire.png}\hspace*{1em}\includegraphics[width=0.3\linewidth]{wire.png}
...
\begin{center}
\begin{subfigure}{0.52\textwidth}
\includegraphics[width=\linewidth]{theta_l_data.pdf}
\caption{$\theta - L$, data} \label{fig:2d_cry_2}
\end{subfigure}\begin{subfigure}{0.52\textwidth}
\includegraphics[width=\linewidth]{theta_l_mc.pdf}
\caption{$\theta - L$, Monte Carlo}\label{fig:2d_cry_mc_2}
\end{subfigure}
\begin{subfigure}{0.52\textwidth}
\includegraphics[width=\linewidth]{ratio_theta_l.pdf}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.3\linewidth]{image.png}\includegraphics[width=0.65\linewidth]{image2.png}
\end{center}
...
\begin{center}
\begin{subfigure}{0.55\textwidth}
\includegraphics[width=\linewidth]{xy_500.pdf}
\caption{Efficiency as a function of $\theta_{xy}$.} \label{fig:xy_500}
\end{subfigure}\begin{subfigure}{0.55\textwidth}
\includegraphics[width=\linewidth]{yz_500.pdf}
\caption{Efficiency as a function of $\theta_{yz}$}\label{fig:yz_500}
\end{subfigure}
\begin{subfigure}{0.55\textwidth}
\includegraphics[width=\linewidth]{l_500.pdf}
