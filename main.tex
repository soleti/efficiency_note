...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.6\linewidth]{figures/purity.pdf}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.6\linewidth]{figures/significance.pdf}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.6\linewidth]{figures/sampling.pdf}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=0.6\linewidth]{figures/crt.png}
