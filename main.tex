...
We intend to include this analysis in a paper to be submitted to JINST. The figures that will be carried forward to the paper are Figs. \ref{fig:coord}, \ref{fig:scheme}, \ref{fig:mucs}, \ref{fig:evd}, \ref{fig:purity}, \ref{fig:3d}, \ref{fig:significance}, \ref{fig:wires}, \ref{fig:example}, \ref{fig:1d}, \ref{fig:2d}.
