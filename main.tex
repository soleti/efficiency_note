...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption{Monte Carlo and data three-dimensional reconstruction efficiency as a function of the starting angles $\theta$, $\phi$ and the extrapolated track length $L$. A larger box correspond to a larger efficiency. The empty region in the upper part of the plot correspond to a region of the parameter space not covered by our dataset.}\label{fig:3d}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \end{subfigure}
  \caption{Monte Carlo (red line) and data (black points) reconstruction efficiency as a function of the starting angles $\theta$, $\phi$ and the extrapolated track length $L$. Data statistical error are correspond to the grey boxes.}\label{fig:1d}
\end{figure}
