...
\begin{equation}
  \epsilon_{\mathrm{true}} = \frac{\mathrm{N.~of~reco.~MuCS~cosmic-rays}}{\mathrm{N.~of~MuCS~events}}.
\end{equation}
...
\begin{equation}
  p=\frac{\mathrm{N.~of~reco.~MuCS~cosmic-rays~within~}d_{\mathrm{max}}}{\mathrm{N.~of~MuCS-tagged~events~within~}d_{\mathrm{max}}}.
\end{equation}
